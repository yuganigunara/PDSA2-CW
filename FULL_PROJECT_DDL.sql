...
CREATE INDEX IF NOT EXISTS idx_game_jumps_game_id ON game_jumps(game_id);
CREATE INDEX IF NOT EXISTS idx_algorithm_runs_game_algo ON algorithm_runs(game_id, algorithm_name);
